...
public class DarkSteelChest extends ModdedBlockContainer implements IHasModel {
	
	
	public DarkSteelChest(String name, Material material, CreativeTabs tab) {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityDarkSteelChest)
            {
                ((TileEntityDarkSteelChest)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        return new TileEntityDarkSteelChest();
    }
