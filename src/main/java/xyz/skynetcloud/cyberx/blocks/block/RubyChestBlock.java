...
public class RubyChestBlock extends ModdedBlockContainer implements IHasModel {
	
	
	public RubyChestBlock(String name, Material material, CreativeTabs tab) {
		super(name, material, tab);
	}

	public boolean isOpaqueCude(IBlockState state)
	{
		return false;
	}
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityRubyChest)
            {
                ((TileEntityRubyChest)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
		if(!worldIn.isRemote)
		{
			playerIn.openGui(Main.instance, Main.RUBY_CHEST_GUI_ID, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
