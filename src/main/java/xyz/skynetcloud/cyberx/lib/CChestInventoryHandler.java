package xyz.skynetcloud.cyberx.lib;
...
public class CChestInventoryHandler implements IItemHandlerModifiable
{
    TileEntityChestInit inv;

    public CChestInventoryHandler(TileEntityChestInit inventory)
    {
        this.inv = inventory;
    }
