...
{
	public static class CloudChestModel extends ModelBase{
	...
	public static class RubyChestModel extends ModelBase {
		
		public ModelRenderer chestKnob;
	    public ModelRenderer chestLid;
	    public ModelRenderer chestBelow;

	    public RubyChestModel() {
	        this.textureWidth = 64;
	        this.textureHeight = 64;
	...
	public static class DarkSteelChestModel extends ModelBase {
		
		public ModelRenderer chestKnob;
	    public ModelRenderer chestLid;
	    public ModelRenderer chestBelow;

	    	public DarkSteelChestModel() {
	        this.textureWidth = 64;
	        this.textureHeight = 64;
