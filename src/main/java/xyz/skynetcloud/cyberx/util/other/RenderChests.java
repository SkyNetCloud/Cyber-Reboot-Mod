...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID + ":textures/blocks/vibranium_chest.png");
	private final ChestModels MODEL = new ChestModels();
	
	@Override
	public void render(TileEntityChestInit te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) 
	{
		GlStateManager.enableDepth();
        GlStateManager.depthFunc(515);
        GlStateManager.depthMask(true);
    	
        ChestModels model = MODEL;
