package xyz.skynetcloud.cyberx.world.generation.chunks;
...
public class ChunkGeneratorEndTemplate implements IChunkGenerator
{
	...
	protected static final IBlockState MAIN_BLOCK = BlockInit.VIBRANIUM_BLOCK.getDefaultState();
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.DARKNESS);
        }
